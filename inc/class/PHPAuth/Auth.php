...
class Auth/* implements AuthInterface*/
{
    ...
    public function login($email, $password, $remember = 0, $captcha_response = null)
    {
        ...
        if ($validateEmail['error'] == 1) {
            $this->addAttempt();
            $return['message'] = $this->__lang("account_email_invalid");
...
";
    ...
    * @return int $uid
    */
    public function addUser($email, $password, $params = [], &$use_email_activation, $hash_password = true)
    {
        $return['error'] = true;
    ...
    */
    ...
    protected function checkCaptcha($captcha)
    {
            ...
            return json_decode(file_get_contents($url."?".http_build_query($data)))->success;
