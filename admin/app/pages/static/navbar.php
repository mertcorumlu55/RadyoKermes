...
<!--            </li>-->
            <li class="dropdown">
                <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown"  aria-expanded="false" >
                    <div class="peer mR-10" style="margin-right: 0!important;">
                        <i class="w-2r bdrs-50p fa fa-user" style="font-size:25px;text-align: center" ></i>
                    </div>
                    <div class="peer">
                        <span class="fsz-sm c-grey-900"><?//$userData["name"]. " ".$userData["surname"]?> <i class="fa fa-angle-down"></i></span>
                    </div>
                </a>
